...
const getColor = (x) => `linear-gradient(90deg, #710707 ${x}%, #C4C4C4 ${x}%)`;
...
videoProgress.addEventListener('oninput', () => videoMousedown && scrub());
videoProgress.addEventListener('mousedown', () => (videoMousedown = true));
videoProgress.addEventListener('mouseup', () => (videoMousedown = false));
